<template>
  <section v-if="hotel" class="max-w-5xl mx-auto p-8">
    ...
    <div class="flex flex-col gap-3">
      <p class="inline-flex gap-2 text-purple-500 font-bold"> <img src="../assets/star-svgrepo-com.svg" alt="star rating" width="20"> Hotel Rating: <span class="text-black"> {{ hotel.summary?.overview.propertyRating.rating }} stars.</span> </p>
      
        <p  class="inline-flex items-center justify-start gap-1 text-purple-500 font-bold">
           <img src="../assets/location.svg" alt="location" width="20"> 
          Location area: <span class="text-black">{{ hotel.summary?.location.address.addressLine }}</span>
        </p>
        <p  class="inline-flex items-start justify-start gap-1 text-purple-500 font-bold">
           <img src="../assets/around.svg" alt="around" width="20"> 
          What is around: 
        </p>
        <p class="text-slate-600 font-bold">{{ hotel.summary?.location.whatsAround.editorial.content[0]}}</p>
        ...
        <p  class="inline-flex items-center justify-start gap-1 text-purple-500 font-bold">
          ...
          Review: <span class="text-black">{{ hotel.reviewInfo
?.summary.overallScoreWithDescriptionA11y.value}}</span>
        </p>
